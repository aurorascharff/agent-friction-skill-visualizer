/**
 * Sample friction log shown when the user clicks 'Fill with example'
 * on the home page. Mirrors the published log at:
 *   https://github.com/aurorascharff/fl-view-transition-morph
 * so the visualizer is self-contained — no cross-package import or
 * runtime fetch needed.
 */
export const EXAMPLE_LOG = `# Friction Log: Next.js product grid with React \`<ViewTransition>\` morph
